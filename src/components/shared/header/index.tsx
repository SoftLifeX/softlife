  ...
  return (
    <>
      <div
        ref={wrapperRef}
        className={cn(
          "link fixed right-5 top-5 w-17 h-17 p-4 flex items-center justify-center rounded-full transition-all duration-300",
          ...
          >
            <div className="relative">
              ...
              <div
                aria-hidden
                className={cn(
                  "absolute w-15 h-15 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border pointer-events-none -z-1 animate-pulse-ring",
              ...
              <div
                ...
                className={cn(
                  ...
                  isActive
                    ? "hidden animate-none w-13 h-13"
                    : "block w-12 h-12 animate-pulse-dot",
                  scrolled ? "scale-100" : "scale-0",
              ...
              <button
                ...
                className={cn(
                  "relative w-12 h-12 rounded-full flex items-center justify-center cursor-pointer touch-none select-none transition-transform active:scale-95",
                  scrolled ? "scale-100" : "scale-0",
                  isIntersecting ? "bg-background" : "bg-foreground"
                )}
