    ...
    >
      ...
      <div ref={containerRef} className="px py contact flex flex-col items-center justify-center min-h-[90svh]">
        ...
        <div className="contact-links gsap-hide mt-12 flex flex-col sm:flex-row items-center gap-6 sm:gap-10">
          ...
          <Link href="tel:+2348139331585" className="link relative inline-block text-sm text-background group">
            ...
            <span ref={contactWidthRef} className="absolute left-0 right-0 -bottom-px h-px bg-current z-0" />
          </Link>
        </div>
      ...
      {/* Footer */}
      <footer ref={footerRef} className="gsap-hide px border-t border-background/10" style={{ visibility: "visible", opacity: 1 }}>
